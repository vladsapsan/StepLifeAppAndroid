package com.StepLife.steplifeapp.MainActivity;
...
import com.StepLife.steplifeapp.EnterenceActivity.ArticleFragment;
import com.StepLife.steplifeapp.EnterenceActivity.ArticleSection;
...
import com.StepLife.steplifeapp.Bluetooth.Fragment.BluetoothModelFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public BluetoothModelFragment bluetoothModelFragment;
    ...
    public void setFragment(Fragment fragment, String tag, int position) {
        if (fm.findFragmentByTag(tag)!=null) {
            ...
            if(active == bluetoothModelFragment){
