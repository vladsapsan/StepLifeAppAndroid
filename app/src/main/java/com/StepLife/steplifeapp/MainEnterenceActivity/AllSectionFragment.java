...
import com.StepLife.steplifeapp.ui.FirebaseData.LoadFireBaseReferenceUseCase;
...
public class AllSectionFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mDataBase = LoadFireBaseReferenceUseCase.getDataBaseReference(LoadFireBaseReferenceUseCase.Section_Article_Key);
        //Лист всех статей
